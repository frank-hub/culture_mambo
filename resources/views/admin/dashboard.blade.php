...
<!-- Mirrored from metropolitanhost.com/themes/themeforest/html/costic/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Oct 2023 07:45:21 GMT -->
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width,initial-scale=1">
  <title>Culture Mambo Dashboard</title>
  <!-- Iconic Fonts -->
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
    ...
    <div class="logo-sn ms-d-block-lg">
      <a class="pl-0 ml-0 text-center" href="index.html">
        <img src="{{asset('admin/assets/img/costic/costic-logo-216x62.png')}}" alt="logo">
      </a>
    </div>
    <!-- Navigation -->
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="dashboard" class="collapse" aria-labelledby="dashboard" data-parent="#side-nav-accordion">
          <li> <a href="index.html">Culture Mambo</a>
          </li>
        </ul>
      </li>
      <!-- /Dashboard -->
  ...
  <main class="body-content">
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="index.html"><img src="{{asset('admin/assets/img/costic/costic-logo-84x41.png')}}" alt="logo"> </a>
      </div>
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
            ...
            <li class="ms-scrollable ms-dropdown-list">
              <a class="media p-2" href="#">
                <div class="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
                  <img src="{{asset('admin/assets/img/costic/customer-3.jpg')}}" class="ms-img-round" alt="people">
                </div>
              ...
              <a class="media p-2" href="#">
                ...
                <div class="media-body"> <span>Dear John, I was told you bought Culture Mambo! Send me your feedback</span>
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img class="ms-user-img ms-img-round float-right" src="{{asset('admin/assets/img/costic/customer-6.jpg')}}" alt="people">
          </a>
  ...
  <script src="{{asset('admin/assets/js/perfect-scrollbar.js')}}">
  </script>
  <script src="{{asset('admin/assets/js/jquery-ui.min.js')}}">
  </script>
  <!-- Global Required Scripts End -->
  <!-- Page Specific Scripts Start -->

  <script src="{{asset('admin/assets/js/Chart.bundle.min.js')}}">
  </script>
  ...
  <script src="{{asset('admin/assets/js/d3.v3.min.js')}}">
  </script>
  <script src="{{asset('admin/assets/js/topojson.v1.min.js')}}">
  </script>
  <script src="{{asset('admin/assets/js/datatables.min.js')}}">
  </script>
  <script src="{{asset('admin/assets/js/data-tables.js')}}">
  </script>
