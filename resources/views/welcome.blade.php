...
<head>
	...
	<meta name="keywords" content="restaurant, culture mambo,food, restro, hotel, best restaurant, club">
	<meta property="og:title" content="Culture Mambo is got to restaurant and club for your food and entertainment">	<meta property="og:image" content="../../swigo.dexignzone.com/xhtml/social-home2.png">
    ...
    <link class="skin" rel="stylesheet" href="{{asset('assets/css/skin/skin-2.css')}}">
    <link class="skin" rel="stylesheet" href="{{asset('assets/css/skin/skin-3.css')}}">
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu cart-list">
                                            <li class="cart-item">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <span class="dz-price">Ksh28.00</span>
                                            ...
                                            <li class="cart-item">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <span class="dz-price">Ksh20.00</span>
                                                        <span class="item-close">&times;</span>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="cart-item">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <span class="dz-price">Ksh15.00</span>
                                                        <span class="item-close">&times;</span>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="cart-item text-center d-flex justify-content-between">
                                                ...
                                                <h6 class="text-primary mb-0">Ksh63</h6>
                                            </li>
                                    ...
                                    <ul class="mega-menu">
                                        ...
                                        <li><a href="javascript:;">Our Services</a>
                                            <ul>
                                                ...
                                                <li><a href="our-menu-2.html">Service 2</a></li>
										...
										<div class="banner-content">
											...
											<div class="food-card">
												...
												<div class="dz-body">
													...
													<div class="dz-right">
														<h5 class="text-primary">Ksh10.00</h5>
										...
										<div class="banner-content">
											...
											<div class="food-card">
												...
												<div class="dz-body">
													...
													<div class="dz-right">
														<h5 class="text-primary">Ksh15.00</h5>
														<a href="shop-cart.html" class="btn btn-primary btn-cart"><i class="flaticon-shopping-cart"></i></a>
													</div>
												</div>
												<img class="target-line" src="assets/images/main-slider/slider2/line.png" alt="/">
				...
				<div class="row">
					<div class="col-lg-4 col-md-12 m-b30 wow fadeInUp" data-wow-delay="0.2s">
						<div class="adv-box style-1" style="background-image:url('assets/images/adv/pic2.png'); background-repeat:no-repeat; background-position:center; background-size:cover;">
							...
							<div class="adv-media">
								<img class="main-media" src="{{asset('imgs/ads/13.jpeg')}}" alt="/">
					...
					<div class="col-lg-4">
						<div class="row">
							<div class="col-lg-12 col-md-6 m-b30 wow fadeInUp" data-wow-delay="0.4s">
								<div class="adv-box style-4" style="background-image:url('{{asset('imgs/ads/11.jpeg')}}'); background-repeat:no-repeat; background-size:375px 253px">
									<div class="adv-media">
										{{-- <img src="assets/images/adv/pic4.png" alt="/"> --}}
                                        <div class="adv-content">
                                            {{-- <span class="special ">TODAY SPECIAL</span> --}}
                                            <h4 class="title text-white">Today's Special</h4>
							...
							<div class="col-lg-12 wow fadeInUp" data-wow-delay="0.8s">
								<div class="adv-box style-4" style="background-image:url('{{asset('imgs/ads/12.jpeg')}}'); background-repeat:no-repeat; background-size:cover;">
									<div class="adv-media">
										{{-- <img src="assets/images/adv/pic4.png" alt="/"> --}}
                                        <div class="adv-content">
                                            {{-- <span class="special ">TODAY SPECIAL</span> --}}
                    ...
                    <div class="col-lg-4 col-md-12 m-b30 wow fadeInUp" data-wow-delay="0.2s">
						<div class="adv-box style-1" style="background-image:url('assets/images/adv/pic2.png'); background-repeat:no-repeat; background-position:center; background-size:cover;">
							...
							<div class="adv-media">
								<img class="main-media" src="{{asset('imgs/ads/14.jpeg')}}" alt="/">
								{{-- <div class="item-media offer-label">
									<img src="assets/images/adv/label.png" alt="/">
									<span class="">50% OFF</span>
								</div> --}}
		...
		<section class="content-inner">
			<div class="container">
                <div class="section-head text-center">
					<h2 class="title wow flipInX" data-wow-delay="0.2s">Our Services</h2>
				</div>
				<div class="row">
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Tantalizing Food</a></h5>
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Best Club</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-sm-6 m-b30">
						<div class="icon-bx-wraper style-3">
							...
							<div class="icon-content">
								<h5 class="title"><a href="service-detail.html">Events Reservation</a></h5>
								<p>Lorem Ipsum is simply dummy text of the printing and </p>
							</div>
						</div>
					</div>
							...
							<div class="row justify-content-between">
								<div class="col-xl-4 col-lg-4 m-lg-0 m-b20 wow fadeInUp" data-wow-delay="0.4s">
									<div class="footer-logo">
										<a href="index.html" class="anidm-logo-white">
											<img src="assets/images/clogo.png" style="height: 100px" alt="/">
										</a>
									</div>
			...
			<div class="footer-bottom">
				<div class="row">
					<div class="col-xl-6 col-lg-6">
						<span class="copyright-text">Copyright © 2023 <a href="" target="_blank">Culture Mambo</a>. All rights reserved.</span>
					</div>
				</div>
            </div>
        </div>
