	...
	<div class="page-content bg-white">
		...
		<section class="content-inner-1">
				...
				<div class="row loadmore-content">
					<div class="col-lg-4 col-md-4">
						<div class="dz-card style-1 overlay-shine dz-img-effect zoom m-b30">
							<div class="dz-media">
								<a href="blog-standard.html"><img src="{{asset('imgs/24.jpeg')}}" alt="/"></a>
							</div>
							{{-- <div class="dz-info">
								<div class="dz-meta">
									<ul>
                    ...
                    <div class="col-lg-4 col-md-4">
						<div class="dz-card style-1 overlay-shine dz-img-effect zoom m-b30">
							<div class="dz-media">
								<a href="blog-standard.html"><img src="{{asset('imgs/ads/15.jpeg')}}" alt="/"></a>
							</div>
							{{-- <div class="dz-info">
								<div class="dz-meta">
									<ul>
            ...
            <div class="text-center">
				<a href="https://www.instagram.com/culture.mambo.lounge/" class="mt-5 btn btn-primary btn-md shadow-primary m-r30 btn-hover-1"><span>Follow Us On Instagram</span></a>
            </div>
		</section>
		<!-- Blog Section -->
